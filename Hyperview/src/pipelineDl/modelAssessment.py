...
if __name__ == "__main__":
    ...
    for i, seed in enumerate(assessment_seeds):
        ...
        if not baseline_only and (kd_study["run_flags"]["pruning"] or not any(kd_study["run_flags"].values())):
        ...
        if not baseline_only and (kd_study["run_flags"]["distillation"] or not any(kd_study["run_flags"].values())):
